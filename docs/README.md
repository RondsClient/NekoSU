# NekoSU
<img align='right' src='SukiSU-mini.svg' width='220px' alt="nekosu logo">

> **A secondary development branch based on [SukiSU Ultra](https://github.com/ShirkNeko/SukiSU-Ultra)**
> 
> SukiSU Ultra is forked from [KernelSU](https://github.com/tiann/KernelSU) by tiann

**English** | [简体中文](./zh/README.md) | [日本語](./ja/README.md) | [Türkçe](./tr/README.md) | [Русский](./ru/README.md)

A kernel-based root solution for Android devices, based on SukiSU Ultra with custom modifications.

[![License: GPL v2](https://img.shields.io/badge/License-GPL%20v2-orange.svg?logo=gnu)](https://www.gnu.org/licenses/old-licenses/gpl-2.0.en.html)
[![License: GPL v3](https://img.shields.io/badge/License-GPL%20v3-orange.svg?logo=gnu)](https://www.gnu.org/licenses/gpl-3.0.html)

## About This Fork

NekoSU is a secondary development branch based on:
- **[SukiSU Ultra](https://github.com/ShirkNeko/SukiSU-Ultra)** by ShirkNeko
- Which is forked from **[KernelSU](https://github.com/tiann/KernelSU)** by tiann

All credit goes to the original authors. This fork adds custom modifications while maintaining GPL compliance.
...
**NekoSU is a GPL-licensed open source project. Any modifications must remain open source under GPL.**

## Credit

**This project is based on:**
- [SukiSU Ultra](https://github.com/ShirkNeko/SukiSU-Ultra) by ShirkNeko - our direct upstream
- [KernelSU](https://github.com/tiann/KernelSU) by tiann - the original upstream project

**SukiSU Ultra's credits:**
