...
import com.nekosu.ui.component.miuix.SendLogDialog
                ...
                item {
                    ...
                    KsuIsValid {
                        ...
                        Card(
                            ...
                            SwitchPreference(
                                title = stringResource(id = R.string.settings_hide_icon),
                                summary = stringResource(id = R.string.settings_hide_icon_summary),
                                startAction = {
                                    Icon(
                                        Icons.Rounded.LayersClear,
                                        modifier = Modifier.padding(end = 6.dp),
                                        contentDescription = stringResource(id = R.string.settings_hide_icon),
                                        tint = colorScheme.onBackground
                                    )
                                },
                                checked = uiState.hideIcon,
                                onCheckedChange = actions.onSetHideIcon
                            )
                        }
                    }
